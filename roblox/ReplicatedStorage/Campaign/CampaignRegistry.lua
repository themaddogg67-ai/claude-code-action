...
CampaignRegistry.Seasons = {
	...
	{ id = 3,  title = "Orders From Above",     boss = "Null",          status = "built",
	  map = "ShadowlandsBuilder", route = "ShadowlandsCampaign",
	  summary = "Minus was only a general — the Warriors descend into Null's Shadowlands to end the master of darkness." },
	...
	{ id = 5,  title = "The Void Overlord",     boss = "Void Overlord", status = "built",
	  map = "GildoniaBuilder", route = "GildoniaCampaign",
	  summary = "On the jungle planet Gildonia the Warriors defeat Void Overlord, then answer a distress beacon to Omega's planet." },
	...
	{ id = 7,  title = "Omega's Chaos",         boss = "Omega",         status = "built",
	  map = "RuinedCityBuilder", route = "RuinedCityCampaign",
	  summary = "Omega breaks the fields and rampages through the ruined city; Looney unlocks his awakening and ends him." },
